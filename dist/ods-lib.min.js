...
return Qo}angular.module("ods-lib").factory("OdsFormService",e),e.$inject=["OdsFieldType","OdsComponentType","OdsDateTimeFormat","$window","dialogs","$resource","OdsPosition","EventDataFactory","OdsEvent"]}(),angular.module("ods-lib").directive("odsForm",y),y.$inject=["OdsFormService","$timeout","dialogs","$uibModal"],angular.module("ods-lib").directive("odsSchema",R),R.$inject=["OdsFormService","EventDataFactory","OdsEvent"],angular.module("ods-lib").directive("odsFormInfo",K),K.$inject=[],angular.module("ods-lib").directive("odsViewer",C),C.$inject=["OdsFormService","uibDateParser"],angular.module("ods-lib").directive("odsFormToolbar",T),T.$inject=["OdsFormService","$sessionStorage","dialogs","EventDataFactory","OdsEvent"],angular.module("ods-lib").directive("odsCheckList",U),U.$inject=[],angular.module("ods-lib").directive("odsModel",E),E.$inject=["OdsFormService"],angular.module("ods-lib").directive("odsGridRenderProps",k),k.$inject=["OdsFormService"],angular.module("ods-lib").directive("odsGridRender",O),O.$inject=["OdsFormService","dialogs"],angular.module("ods-lib").directive("odsSuggestionOptions",S),S.$inject=["OdsFormService","OdsCkeditor"],angular.module("ods-lib").directive("odsAccordionProperties",z),z.$inject=["OdsFormService","dialogs"],angular.module("ods-lib").directive("odsTableProps",D),D.$inject=["OdsFormService"],angular.module("ods-lib").directive("odsTable",B),B.$inject=["OdsFormService","dialogs","OdsComponentType","OdsFieldType"],angular.module("ods-lib").directive("odsTableTotal",P),P.$inject=["OdsFormService"],angular.module("ods-lib").directive("odsFieldCheckboxlistOptions",I),I.$inject=["OdsFormService"],angular.module("ods-lib").directive("odsField",j),j.$inject=["OdsFormService","dialogs"],angular.module("ods-lib").directive("odsFieldMultiSelectOptions",q),q.$inject=["OdsFormService"],angular.module("ods-lib").directive("odsSection",M),M.$inject=["OdsFormService","dialogs"],angular.module("ods-lib").directive("odsFieldRadioOptions",N),N.$inject=["OdsFormService"],angular.module("ods-lib").directive("odsRow",L),L.$inject=["OdsFormService","dialogs"],angular.module("ods-lib").directive("odsFieldSelectOptions",V),V.$inject=["OdsFormService"],angular.module("ods-lib").directive("odsCanvasPainterColorSelector",H),H.$inject=["OdsFormService"],angular.module("ods-lib").directive("odsCanvasPainter",Q),Q.$inject=["dialogs"],angular.module("ods-lib").directive("odsCanvasPainterColors",G),G.$inject=[],function(){function e(e,o,t,i){function l(e,o){var t="";if(e&&e.optionValue){var i=n(e.optionValue);""!==i&&(t+=e.groupValue,t+=i)}var l=o+t;return l!==o?l:""}function n(e){var o="";return Object.entries(e).forEach(function(e,t){e[1]&&(o+=0===t?" "+e[0]:s+e[0])}),o}const a=". ",s=", ";e.field=t,e.save=function(e){e&&e.groups&&(e.value="",e.groups.forEach(function(o,t){e.value+=0===t?l(o,""):l(o,a)}),e.value+=""===e.value?e.modal.value:a+e.modal.value),i.close()},e.clear=function(e){e.value="",e.modal.value="",e.groups.forEach(function(e){e.optionValue=""})},e.cancel=function(){i.dismiss("cancel")}}angular.module("ods-lib").controller("OdsOptionsModalController",e),e.$inject=["$scope","OdsFormService","field","$uibModalInstance"]}()}();