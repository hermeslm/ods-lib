...
var PDFViewerApplication = {
    ...
    initUI: function pdfViewInitUI() {
        ...
        document.getElementById('pdf-viewer-previous').addEventListener('click', function () {
            PDFViewerApplication.page--;
        });

        document.getElementById('pdf-viewer-next').addEventListener('click', function () {
            PDFViewerApplication.page++;
        });

        document.getElementById('pdf-viewer-zoomIn').addEventListener('click', function () {
            PDFViewerApplication.zoomIn();
        });

        document.getElementById('pdf-viewer-zoomOut').addEventListener('click', function () {
            PDFViewerApplication.zoomOut();
        });

        document.getElementById('pdf-viewer-pageNumber').addEventListener('click', function () {
            this.select();
        });

        document.getElementById('pdf-viewer-pageNumber').addEventListener('change',
            function () {
        ...
        container.addEventListener('pagechange', function (evt) {
            ...
            document.getElementById('pdf-viewer-pageNumber').value = page;
            document.getElementById('pdf-viewer-previous').disabled = (page <= 1);
            document.getElementById('pdf-viewer-next').disabled = (page >= numPages);
        }, true);
    }
};
